...
const WebgiViewer = forwardRef((props, ref) => {
  {
    ...
    useImperativeHandle(ref, () => ({
      triggerPreview() {
        setPreviewMode(true);
        canvasContanerRef.current.style.pointerEvents = "all";
    ...
    const handleExit = useCallback(() => {
      canvasContanerRef.current.style.pointerEvents = "none";
    ...
    }, [canvasContanerRef, viewerRef, positionRef, cameraRef, targetRef]);

    return (
      <div ref={canvasContanerRef} id="webgi-canvas-container">
